...
🏆️**수상**: 제7회 교육 공공데이터 분석활용대회 1위 (대상)
...
├── README.md                      # 프로젝트 설명
├── [SATIMA] 지역별 사교육 현황 분석과 학습자원 최적화_SHAP 기반 인사이트와 입지 최적화 모델 적용.pdf # 프로젝트 발표 자료
```
...
### **1️⃣ 데이터 전처리**
- **데이터 수집 및 변수 가공**: 다양한 출처로부터 교육 관련 공공 데이터를 수집하고, 변수들을 시군구별로 가공
...
### **6️⃣ 의사결정 대시보드 구축**
- 지속적인 현황 파악과 지역별 공급-수요에 따른 유동적 최적화가 가능하여 실무자의 의사결정을 지원할 수 있는 시스템을 Streamlit을 활용하여 구현
